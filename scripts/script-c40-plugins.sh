...
unzip -q "${INSTALL_FOLDER}commands.zip"
...
unzip -q "${INSTALL_FOLDER}MauticAdvancedTemplatesBundle.zip"
...
unzip -q "${INSTALL_FOLDER}MauticPostalServerBundle.zip"
...
unzip -q "${INSTALL_FOLDER}JotaworksDoiBundle.zip"
