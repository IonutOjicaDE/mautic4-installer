...
wget -q 'https://github.com/IonutOjicaDE/mautic4-ro-translation/archive/refs/heads/main.zip' -O mautic4-ro-translation.zip
unzip -q mautic4-ro-translation.zip
mv "mautic4-ro-translation/ro_RO" "${MAUTIC_FOLDER}translations/"
rm mautic4-ro-translation
rm mautic4-ro-translation.zip
